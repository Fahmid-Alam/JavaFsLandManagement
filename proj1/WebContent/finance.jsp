...
<body>
<h1 class="text-center"> Finance Page </h1>
...
<div class="row">
		...
		try
		{
			...
			String query = "select * from legal where department='finance' order by sno desc";
			...
			while(rs.next())
			{
				...
				out.println("<td>"+status+"</td>");
                    ...
                    out.println("<input type='hidden' name='from' value='finance' />");
